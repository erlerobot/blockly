...
Blockly.Blocks['get_orientation'] = {
  init: function() {
    this.appendValueInput("OrientationW")
        .appendField("Orientation W");
    this.appendValueInput("OrientationX")
        .appendField("Orientation X");
    this.appendValueInput("OrientationY")
        .appendField("Orientation Y");
    this.appendValueInput("OrientationZ")
        .appendField("Orientation Z");
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setColour(0);
    this.setTooltip('');
